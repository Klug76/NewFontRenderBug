...
:: Android packaging
set AND_CERT_NAME="NewFontRenderBug"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\NewFontRenderBug.p12
...
set IOS_PROVISION=cert\NewFontRenderBug.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=NewFontRenderBug
